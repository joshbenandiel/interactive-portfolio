  ...
  return (
    <BackgroundContainer theme={theme}>
      ...
      <div className='layer-1'>
        <img className='shapes' src={one} data-speed={-11} alt='shapes'/>
        <img className='shapes' src={two} data-speed={10} alt='shapes'/>
        <img className='shapes' src={three} data-speed={-6} alt='shapes'/>
      </div>
